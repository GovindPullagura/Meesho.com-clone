              ...
              <PopoverBody>
                {isAuth ? (
                  ...
                  >
                    ...
                    >
                      <SlBag />
                      <Text fontSize="15px" p="0 0 0 15px">
                        My Orders
                      </Text>
                    </Button>
                    {admin.includes(user.id) && (
                      ...
                      >
                        <GrUserAdmin />
                        <Text fontSize="15px" p="0 0 0 13px">
                    ...
                    >
                      ...
                      <Text fontSize="15px" p="0 30px 0 10px">
                        Logout
                      </Text>
                    </Button>
                  </VStack>
          ...
          <WrapItem>
            <Popover trigger={"hover"}>
              <PopoverTrigger>
                ...
                >
                  <Link to="/womenPage">Women Ethnic</Link>
                </Button>
              </PopoverTrigger>
              <PopoverContent w={"100%"} m={"-8px 0 0 0"}>
                ...
                >
                  <Grid templateColumns="repeat(6, auto)">
                    <VStack p={2}>
                      <Text as="b" color="#f43397" m="10px">
                        All Women Ethnic
                      </Text>
                      <Text>
                        <Link to="/womenPage">View All</Link>
                      </Text>
                    </VStack>
          ...
          <WrapItem>
            <Popover trigger={"hover"}>
              <PopoverTrigger>
                ...
                >
                  <Link to="/womenPage">Women Western</Link>
                </Button>
              </PopoverTrigger>
              <PopoverContent w={"100%"} m={"-8px 0 0 0"}>
                <PopoverBody
