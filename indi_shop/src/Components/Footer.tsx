...
export const Footer = () => {
  ...
  return <Box bg='#f9f9f9' p='5' textAlign='left' m={'6% 0 0 0'}>
    <Grid templateColumns='repeat(6, auto)' gap='7' m='5% 10% 3%'>
      <Box>
        <Text as='b' fontSize='35px'>Shop Non-Stop on Meesho</Text>
      ...
      <Box>
        <Text as='b' color='grey' fontSize='15px'>Careers</Text>
        <br />
        <br />
        <Text as='b' color='grey' fontSize='15px'>Become a supplier</Text>
        <br />
        <br />
        <Text as='b' color='grey' fontSize='15px'>Hall of Fame</Text>
      </Box>
      <Box>
        <Text as='b' color='grey' fontSize='15px'>Legal and Policies</Text>
        <br />
        <br />
        <Text as='b' color='grey' fontSize='15px'>Meesho Tech Blog</Text>
        <br />
        <br />
        <Text as='b' color='grey' fontSize='15px'>Notices and Returns</Text>
      </Box>
      <Box>
        <Text as='b' fontSize='15px'>Reach out to us</Text>
        <br />
        <br />
        <HStack>
      ...
      <Box>
        <Text as='b' fontSize='15px'>Contact Us</Text>
        <br />
        <br />
        <Text fontSize={'10px'}>Fashnear Technologies Private Limited, CIN: U74900KA2015PTC082263 06-105-B, 06-102, (138 Wu) Vaishnavi Signature, No. 78/9, Outer Ring Road, Bellandur, Varthur Hobli, Bengaluru-560103, Karnataka, India E-mail address: query@meesho.com © 2015-2022 Meesho.com</Text>
      </Box>
    </Grid>
  </Box>
