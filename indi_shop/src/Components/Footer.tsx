  ...
  return <Box bg='#f9f9f9' p='5' textAlign='left' m={'6% 0 0 0'}>
    <Grid templateColumns='repeat(6, auto)' gap='7' m='5% 10% 3%'>
      ...
      <Box>
        ...
        <br />
        <br />
        <Text>Fashnear Technologies Private Limited, CIN: U74900KA2015PTC082263 06-105-B, 06-102, (138 Wu) Vaishnavi Signature, No. 78/9, Outer Ring Road, Bellandur, Varthur Hobli, Bengaluru-560103, Karnataka, India E-mail address: query@meesho.com © 2015-2022 Meesho.com</Text>
      </Box>
    </Grid>
  </Box>
