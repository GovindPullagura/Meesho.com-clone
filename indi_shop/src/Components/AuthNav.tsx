...
import { Box, Image, Input, HStack, InputGroup, InputLeftElement, Button, Text, VStack, StackDivider, Popover, PopoverTrigger, Portal, PopoverContent, PopoverBody } from '@chakra-ui/react';
    ...
    return (
        <Box position={'sticky'} top={'0%'} bg={'white'}>
            <HStack height='70px' boxShadow='rgba(0, 0, 0, 0.12) 0px 1px 3px, rgba(0, 0, 0, 0.24) 0px 1px 2px;' spacing={'10'} textAlign='center' justifyContent='center'>
                <Link to={"/"}><Image src="./Indishop_logo.png" alt='logo' width='150px' ml="50px" /></Link>
                <InputGroup width='380px'>
                    <Input type='text' placeholder='Try Saree, Kurti or Search by Product Code' id='search' h='50px' />
                    <InputLeftElement>
