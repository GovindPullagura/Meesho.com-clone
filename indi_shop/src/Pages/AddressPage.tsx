        ...
        <div>
            ...
            <Box display='flex' mt='10px'>
                <Box w='600px' mt='15px' ml='350px'>
                    ...
                    <Text textAlign="start" pt='7px' pl='22px' fontSize='12px'>PAY IN CASH</Text>
                    <Box height='300px' >
                        ...
                        <Box mt='0' ml='370px'>
                            <Menu>
                                ...
                                <MenuList>
                                    <MenuGroup>
                                        <Flex minH={'50vh'} w='350px' align={'center'} justify={'center'} >
                ...
                <Box w="350px" m="5" h='280px' ml='0' borderRadius='8px' mt='2px'>
                    <Box w="350px" borderRadius={5} p="2">
                        <Text m="2" textAlign="left" fontSize={{ base: "8", sm: "10", md: "16", lg: "20" }} fontWeight="semibold">
                            Price Detailes
                        </Text>
