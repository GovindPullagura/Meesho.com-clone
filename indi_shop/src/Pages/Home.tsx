...
import { Box, Divider, Flex, HStack, StackDivider, Text, VStack, Stack, Heading, Spacer, Grid, GridItem } from "@chakra-ui/layout";
...
const Home = () => {
  ...
  return <div>
    ...
    <HStack w='60%' m='auto' mt='60px'>
      ...
      <Text as='b' fontSize={'4xl'}>Top Categories to choose from</Text>
      <Divider borderColor={'#f43397'} w='25%' />
    </HStack>
    ...
    <Box w='60%' m='auto' mt='60px' h='450px' borderRadius={'10px'}>
      <Image src="https://images.meesho.com/images/marketing/1664343269674.jpg" h='100%' w='100%' borderRadius={'10px'} />
    ...
    <Box w='60%' m='auto' mt='60px' h='400px' borderRadius={'10px'}>
      <Image src="https://images.meesho.com/images/pow/downloadBannerDesktop.webp" h='100%' w='100%' borderRadius={'10px'} />
      <Box h='100%' w='100%' mt='-350' textAlign='right'>
        <VStack p='0 20px 0 150px'>
          <Text fontSize={'30px'} color='#5585f8' as='b' p='0 0 0 230px'>Become a Reseller and</Text>
          <Text fontSize={'45px'} color='#f43397' as='b'>Start your Online Business<br/>with Zero Investment</Text>
          <br/>
          <HStack p='0 0 0 200px'>
            <Button colorScheme={'none'} bg='black' p='25px'>
              <Image src='https://images.meesho.com/images/pow/playstoreIcon.webp' w='130px'/>
            </Button>
            <Button colorScheme={'none'} bg='black' p='25px'>
              <Image src='https://images.meesho.com/images/pow/appstoreIcon.webp' w='130px'/>
            </Button>
          </HStack>
        </VStack>
      </Box>
    ...
    <Box w='60%' m='auto' mt='60px' h='210px' borderRadius={'10px'}>
      <Image src="https://images.meesho.com/images/pow/supplyBannerDesktop.webp" h='100%' w='100%' borderRadius={'10px'} />
      <Box h='100%' w='100%' mt='-170' textAlign='left' ml='40px'>
        <Text color={'white'} as='b' fontSize={'35px'}>Register as a Meesho Supplier</Text>
        <br/>
        <br/>
        <Text color={'white'}>Sell your products to crores of customers at 0% commission</Text>
        <br/>
        <HStack divider={<StackDivider borderColor='white' />}>
          <HStack>
            <BsCheckCircleFill color="green"/>
            <Text color={'white'} as='b'>Grow your business 10x</Text>
          </HStack>
          <HStack>
            <BsCheckCircleFill color="green"/>
            <Text color={'white'} as='b'>Enjoy 100% Profit</Text>
          </HStack>
          <HStack>
            <BsCheckCircleFill color="green"/>
            <Text color={'white'} as='b'>Sell all over India</Text>
          </HStack>
        </HStack>
      </Box>
    </Box>
